...
class Container(containers.DeclarativeContainer):
    ...
    # Repository
    session_repo = providers.Singleton(InMemorySessionRepository,
    ...
    embedding_repo = providers.Singleton(OpenaiEmbeddingRepository,
                                         api_key=settings.openai_api_key,
                                         model=settings.embedding_model)
    retriever_repo = providers.Singleton(ChromaRetrieverRepository,
                                         embedding_repo=embedding_repo,
                                         cache_repo=cache_repo)
    llm_repo = providers.Singleton(OpenaiLLMRepository,
                                   api_key=settings.openai_api_key,
